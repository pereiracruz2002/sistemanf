...
$db['local']['hostname'] = 'produtiv_pin2';
$db['local']['username'] = 'root';
$db['local']['password'] = 'senha';
$db['local']['database'] = 'syngenta_ar';
...
$db['localserver']['database'] = 'produtiv_pin';
$db['localserver']['dbdriver'] = 'mysqli';
...
$db['test']['hostname'] = 'dbmy0055.whservidor.com';
$db['test']['username'] = 'wvcomunica_17';
$db['test']['password'] = 'syngenta10';
$db['test']['database'] = 'wvcomunica_17';
